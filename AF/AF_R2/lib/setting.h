...
// weapon gripper
#define weapon_gripper_pin                   PC_6
#define electromagnet_pin                    PC_7
#define gripper_cylinder_pin                 PC_8
#define extend_motor_id                      5
#define weapon_gripper_freq                  10

#define weapon_gripper_extend_position      1000.0f
#define weapon_gripper_contract_position    -1000.0f
