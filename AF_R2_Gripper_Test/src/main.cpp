...
DigitalOut gripper_cylinder(gripper_cylinder_pin);
vesc extend_motor(extend_motor_id, &_can3, can_baud, Motor_type::m3508);
weapon_gripper weapon_gripper_1(&extend_motor, &gripper, &gripper_cylinder, &electromagnet);
#endif
...
void weapon_gripper_control(){
    ...
    weapon_gripper_1.gripper_cylinder_down();
    ...
    bool gripper_cylinder_flag = false;
    ...
    while(1){
        ...
        if(circle && !prev_circle){
            if(gripper_cylinder_flag){
                weapon_gripper_1.gripper_cylinder_up();
            }
            else{
                weapon_gripper_1.gripper_cylinder_down();
            }

            gripper_cylinder_flag = !gripper_cylinder_flag;
        }
