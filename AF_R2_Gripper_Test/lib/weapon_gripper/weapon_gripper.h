...
class weapon_gripper {
    public:
        weapon_gripper(vesc& extend_motor, DigitalOut& weapon_gripper, DigitalOut& gripper_cylinder,DigitalOut& electromagnet);
        ...
        void gripper_cylinder_up();
        void gripper_cylinder_down();
