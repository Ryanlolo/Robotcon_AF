...
weapon_gripper::weapon_gripper(vesc& extend_motor, DigitalOut& weapon_gripper, DigitalOut& electromagnet) : _extend_motor(extend_motor), _weapon_gripper(weapon_gripper), _electromagnet(electromagnet) {
}

void weapon_gripper::extend(){
    _extend_motor.setPosition(weapon_gripper_extend_position);
}

void weapon_gripper::contract(){
    _extend_motor.setPosition(weapon_gripper_contract_position);
}
